...
<div id="search" style="position:absolute; top:50; left:0; z-index:150; width:100%">
	...
	<table cellpadding=5 width=700 border=0 bgcolor=000000>
		...
		<tr>
			...
			<img src="img/icon_search.png" width=70 height=70 onClick="applyFilter()" alt="Search">
			</td>
			<?php
			// Show Add Offline Patient for Admin & Radiologist
			if ($_SESSION['level'] != 'user') { 
				echo "<td valign=center align=center>";
				echo "<img src=\"img/icon_report.png\" width=70 height=70 onClick=\"document.getElementById('divAddOfflinePatient').style.display = 'block';\" alt=\"Add Offline Report\">";
				echo "</td>";
			}
			?>
		</tr>
